...
check('blog : les 20 cartouches du stock sont couvertes par le grep wording',
  () => BLOG_HTML.length === 22);
...
// Blog LOT 5, 5 cartouches de plus en stock (2026-07-21, cadence quotidienne 03-07/08)
console.log('\n[ Blog LOT 5 ]');
const LOT5_ARTS = ['putting-the-exam-clock-on-listening', 'giving-each-speaker-a-different-voice',
                   'when-assistants-started-recommending-us', 'never-lose-an-essay-again',
...
const ALL_ARTS = NEW_ARTS.concat(LOT4_ARTS).concat(LOT4B_ARTS).concat(LOT5_ARTS).concat('how-i-built-an-ielts-site-with-ai');
