      ...
      groups: [
        {
          ...
          questions: [
            { n: 11, at: 2, label: 'Compost area',     answer: 'F', alt: ['f'] },
            { n: 12, at: 3, label: 'Herb spiral',      answer: 'B', alt: ['b'] },
            { n: 13, at: 4, label: "Children's plot",   answer: 'D', alt: ['d'] },
            { n: 14, at: 5, label: 'Greenhouse',       answer: 'G', alt: ['g'] },
            { n: 15, at: 6, label: 'Pond',             answer: 'A', alt: ['a'] },
          ],
        },
        {
          type: 'mc',
          ...
          questions: [
            { n: 16, at: 7,  text: 'What must volunteers always bring themselves?',
              options: ['Tools', 'Gloves', 'A water bottle'], answer: 1, anchor: ['gloves'] },
            { n: 17, at: 8,  text: 'How often do volunteer sessions take place?',
              options: ['Every weekday', 'Every Saturday', 'Every weekend'], answer: 1, anchor: ['saturday'] },
            { n: 18, at: 9,  text: 'What is NOT allowed in the growing beds?',
              options: ['Food', 'Pets', 'Bicycles'], answer: 1, anchor: ['no pets', 'pets'] },
            { n: 19, at: 10, text: 'Where should watering water be taken from?',
              options: ['The tap by the shed', 'The rainwater tank', 'The pond'], answer: 1, anchor: ['rainwater tank', 'rainwater'] },
            { n: 20, at: 11, text: 'How should volunteers report an absence?',
              options: ['By email', 'By phone', 'By text'], answer: 2, anchor: ['by text', 'text'] },
          ],
        },
      ],
    },
      ...
      groups: [
        {
          ...
          instructions: 'Choose the correct letter, A, B or C.',
          questions: [
            { n: 21, at: 1, text: 'The students will focus on noise near',
              options: ['hospitals', 'schools', 'offices'], answer: 1, anchor: ['schools'] },
            { n: 22, at: 3, text: 'How will they measure the noise?',
              options: ['with a phone app', 'with a sound level meter', 'with a video camera'], answer: 1, anchor: ['sound level meter'] },
            { n: 23, at: 5, text: 'Over what period will they collect data?',
              options: ['two days', 'two weeks', 'two months'], answer: 1, anchor: ['two weeks'] },
            { n: 24, at: 7, text: 'What do they expect to be their main difficulty?',
              options: ['rain', 'wind', 'traffic'], answer: 1, anchor: ['wind'] },
            { n: 25, at: 9, text: 'How often will they log a reading?',
              options: ['every five minutes', 'every fifteen minutes', 'every thirty minutes'], answer: 1, anchor: ['fifteen minutes'] },
          ],
        },
        {
          type: 'matching',
          ...
          questions: [
            { n: 26, at: 11, text: 'Plotting the readings onto a site map', answer: 'A', alt: ['a'], anchor: ['mapping', 'map'] },
            { n: 27, at: 13, text: 'Interviewing teachers and pupils',      answer: 'B', alt: ['b'], anchor: ['interviews'] },
            { n: 28, at: 14, text: 'Recommending background reading',        answer: 'C', alt: ['c'], anchor: ['reading', 'regulations'] },
          ],
        },
        {
          ...
          wordLimit: 2,
          questions: [
            { n: 29, at: 16, label: 'Required length of the report', answer: '2000 WORDS', alt: ['two thousand words', '2000'] },
            { n: 30, at: 18, label: 'Submission deadline',           answer: '12 MAY',     alt: ['twelfth of may', 'may 12', '12th may'] },
          ],
        },
      ],
    },
